...
import type { ConfigEditorBridge, ConfigEditorReadResult, ConfigSaveResult } from '#/config-editor-types.ts'

const configEditor: ConfigEditorBridge = {
  read: () => ipcRenderer.invoke(configEditorChannels.read) as Promise<ConfigEditorReadResult>,
